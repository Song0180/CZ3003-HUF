...
class HufUserAns(models.Model):
    username = models.OneToOneField(AuthUser, models.DO_NOTHING, db_column='username', primary_key=True)
...
class LoginapiHufuser(models.Model):
